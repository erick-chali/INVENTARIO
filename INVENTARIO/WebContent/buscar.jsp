...
<%@ include file="includes/header.jsp" %>
	...
	<div class="col-md-12 col-lg-12">
		<input type="text" id="codigoProducto1" class="form-control" placeholder="Codigo Producto">
	</div>
	
	<div class="table-responsive col-sm-12 col-md-12 col-lg-12 tablesorter">
		<table  id="datosBusqueda" class="table">
		</table>
	</div>
